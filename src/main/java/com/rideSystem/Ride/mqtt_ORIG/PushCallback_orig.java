...
//@Slf4j
//@Component
//public class PushCallback_orig implements MqttCallback {
//    @Autowired
//    private MqttConfiguration_orig mqttConfiguration;
//
//
//
//    @Override
...
//        log.info("连接断开，正在重连");
//        MqttPushClient_orig mqttPushClient = mqttConfiguration.getMqttPushClient();
